...
import { Braces, Check, Code, Copy, Download, FileText } from 'lucide-react'
  ...
  const generatePreview = () => {
    switch (exportOptions.format) {
      ...
      case 'json':
        ...
        break
      case 'nextjs':
        const nextjsExport = exportToNextJS(
          state.pages,
          state.routeMappings,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Embed CSS styles in the export
                  </p>
                </div>
                <Switch
                  id="include-styles"
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setExportOptions({ ...exportOptions, responsive: checked })
                  }
                />
              </div>
            ...
            <div className="p-4 bg-muted rounded-lg">
              ...
              <div className="space-y-1 text-sm text-muted-foreground">
                ...
                <div className="flex justify-between">
                  ...
                  <Badge
                    variant={exportOptions.responsive ? 'default' : 'secondary'}
                  >
          ...
          <div className="space-y-4">
            ...
            <Textarea
              value={
                previewContent ||
                "Click 'Generate Preview' to see the exported code"
              }
              readOnly
