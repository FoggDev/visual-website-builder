...
import { type ComponentTemplate, componentTemplates } from "./component-templates"
...
export const componentRegistry: Record<string, ComponentRegistryItem> = {
  navbar: {
    id: "navbar",
    name: "Navbar",
    description: "Navigation bar with logo and menu items, responsive hamburger menu",
    category: "Layout",
    icon: Menu,
...
export function getComponentRegistryItem(id: string): ComponentRegistryItem | null {
...
export function getComponentsByCategory(category: string): ComponentRegistryItem[] {
  return Object.values(componentRegistry).filter((item) => item.category === category)
}

export function getAvailableCategories(): string[] {
  const categories = new Set(Object.values(componentRegistry).map((item) => item.category))
